...
### 固定域名一键安装命令
```bash
cd ~ && curl -fsSL https://raw.githubusercontent.com/m2kall/agsb/main/agsb-v2.py | python3 - install --uuid b1ebd5fc-9170-45d4-9887-a39c9fc65298 --port 49999 --agk CF-token --domain 自己的域名

```
## 或者

```bash
cd ~ && wget https://raw.githubusercontent.com/m2kall/agsb/main/agsb.py && python3 agsb.py install --uuid 25bd7521-eed2-45a1-a50a-97e432552aca --port 49999 --agk CF-token --domain 自己的域名
```


### 一键安装命令
```bash
cd ~ && wget https://raw.githubusercontent.com/m2kall/agsb/main/agsb.py && python3 agsb.py
```
## 或者

```bash
cd ~ && curl -fsSL https://raw.githubusercontent.com/m2kall/agsb/main/agsb.py | python3 -
```
